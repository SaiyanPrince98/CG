...
// Routers inside cloud
	...
	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1.5,1.5,1.5);
	drawstring(-3.5,1.3,0.0,"REMOTE HACKER");
...
void about()
{
	...
	drawstring(-3.5,-1.5,0.0,"   to avoid over subscription of any of the processing or link capabilities ");
...
void first_screen()
{
	...
	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
    	glColor3f(0.0,1.0,1.0);
	drawstring(-2,1,0,"K.TARUN NAIDU (USN : 1KS16CS035)");
